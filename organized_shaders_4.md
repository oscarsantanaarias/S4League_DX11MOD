# S4 League Shaders — Organized Dump

> Original shader offsets preserved. Code is only reformatted for readability; shader logic is not intentionally changed.

## Shader index

1. [`0x023e3a28`](#0x023e3a28) — `VS_BLUR`, `PS_BLUR`
2. [`0x023e33d8`](#0x023e33d8) — `VS_BLUR`, `PS_BLUR`
3. [`0x023e4198`](#0x023e4198) — `VS_DiffuseMap_ShadeMap_Light1`, `Technique_DiffuseMap_ShadeMap_Light1`
4. [`0x023f8288`](#0x023f8288) — `VS_DiffuseMap_Rigid`, `VS_DiffuseMap_Skinned`, `VS_DiffuseMap_BumpMap_Rigid`, `VS_DiffuseMap_BumpMap_Skinned`, `VS_FX`, `PS_DiffuseMap`, `Technique_DiffuseMap_Rigid`, `Technique_DiffuseMap_Skinned`
5. [`0x023e26b8`](#0x023e26b8) — `VS_TextureNoise`, `VS_ProjectiveShadow`, `VS_ProjectiveShadowCast`, `Technique_TextureNoise`, `Technique_ProjectiveShadow`, `Technique_ProjectiveShadowCast`
6. [`0x023f7b50`](#0x023f7b50) — `VS`, `PS`
7. [`0x023f9a30`](#0x023f9a30) — `VS`, `PS`
8. [`0x023f9870`](#0x023f9870) — `VS`
9. [`0x023e2c38`](#0x023e2c38) — `VS_BLUR`, `PS_BLUR`
10. [`0x023f9f18`](#0x023f9f18) — `VS_DiffuseMap_Rigid`, `VS_DiffuseMap_Skinned`, `VS_DiffuseMap_BumpMap_Rigid`, `VS_DiffuseMap_BumpMap_Skinned`, `PS_DiffuseMap_BumpMap_RefractionMap`, `Technique_DiffuseMap_Rigid`, `Technique_DiffuseMap_Skinned`, `Technique_DiffuseMap_BumpMap_Rigid`
11. [`0x023e8160`](#0x023e8160) — `VS_FX`, `VS_DiffuseMap_LightMap`, `VS_DiffuseMap_LightMap_SpecularMap`, `VS_DiffuseMap_LightMap_Low`, `VS_DiffuseMap_Light0_Rigid`, `VS_DiffuseMap_Light0_Skinned`, `VS_DiffuseMap_Light1_Rigid`, `VS_DiffuseMap_Light1_Skinned`
12. [`0x023e4590`](#0x023e4590) — `VS_FX`, `VS_DiffuseMap_LightMap_Low`, `VS_DiffuseMap_LightMap`, `VS_DiffuseMap_LightMap_SpecularMap`, `VS_DiffuseMap_Light0`, `VS_DiffuseMap_Light1`, `VS_DiffuseMap_ShadeMap_Light1`, `VS_DiffuseMap_SpecularMap_Light1`

---

## 1. `0x023e3a28`

**Vertex shaders:** `VS_BLUR`
**Pixel shaders:** `PS_BLUR`
...
**Vertex shaders:** `VS_DiffuseMap_ShadeMap_Light1`
...
**Vertex shaders:** `VS_DiffuseMap_Rigid`, `VS_DiffuseMap_Skinned`, `VS_DiffuseMap_BumpMap_Rigid`, `VS_DiffuseMap_BumpMap_Skinned`, `VS_FX`
**Pixel shaders:** `PS_DiffuseMap`
...
**Vertex shaders:** `VS_TextureNoise`, `VS_ProjectiveShadow`, `VS_ProjectiveShadowCast`
...
**Vertex shaders:** `VS_DiffuseMap_Rigid`, `VS_DiffuseMap_Skinned`, `VS_DiffuseMap_BumpMap_Rigid`, `VS_DiffuseMap_BumpMap_Skinned`
**Pixel shaders:** `PS_DiffuseMap_BumpMap_RefractionMap`
